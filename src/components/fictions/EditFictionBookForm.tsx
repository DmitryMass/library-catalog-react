...
const EditFictionBookForm: FC<TEditBookFormProps> = ({ book }) => {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: [queryKey.fictionBooks, book._id],
      });
    },
  ...
  return (
    <>
      <h1 className="mb-10 text-md24 font-medium">
        Редагувати художню літературу
      </h1>
...
export default EditFictionBookForm;
